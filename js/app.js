...
async function showMainApp() {
    ...
    if (isAdmin) {
        adminPanelBtn.classList.add('admin-visible');
        btnSaveDefault.style.display = 'inline-block';
    } else {
        adminPanelBtn.classList.remove('admin-visible');
        btnSaveDefault.style.display = 'none';
    }
